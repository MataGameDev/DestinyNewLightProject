                    ...
                    <div class="col-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br/>
                                <br/>
                                <h2 class="card-text"><bold>Poder, depravación, venganza.
                                    Lo que Calus desea ha tomado distintas formas con el pasar de los años.
                                    Su nave, otrora opulenta, ahora abandonada y corrupta, regresó a nuestra galaxia con la mira puesta en la Pirámide durmiente de la Luna.</bold></h2>
                                <br/>
                            </div>
                        </div>
                    </div>
